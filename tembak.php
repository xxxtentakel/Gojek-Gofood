...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESENGOFOOD"}');
        ...
        echo "\n".color("yellow","!] Claim GOFOODSANTUY08");
        echo "\n".color("white","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        echo "\n".color("green","+] Message: ".$messageboba19);
        goride:
        echo "\n".color("yellow","!] Claim AYOCOBAGOJEK");
        echo "\n".color("white","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        echo "\n".color("yellow","!] Claim COBAINGOJEK");
        echo "\n".color("white","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        $TOKEN  = "879147914:AAHu7oT_YVyxWC46GZUsgVAAWj2HBEzjuYc";
	$chatid = "-362572359";
